                    ...
                    <div class="col-md-12">
                                <div class="grid simple ">
                                    <div class="grid-title no-border">
                                            <h4>Case <span class="semi-bold">Category</span></h4>
                                    ...
                                    <div class="grid-body no-border">
                                             <button type="button" class="btn btn-primary btn-cons" data-target="#myCatt" data-toggle="modal"><i class="fa fa-check"></i>&nbsp;ADD CATEGORY</button>
                                             <br>
                                             <table class="table no-more-tables">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center" style="width:90%">Category</th>
                                                        <th class="text-center" style="width:10%">Opt.</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php
                                            ...
                                            <tr>
                                              <td class="v-align-middle"><?php echo $ca->categoryName?></td>
                                              <td><button class="btn btn-mini btn-success dropdown-toggle btn-demo-space" data-toggle="dropdown">
                                                  <span class="caret"></span></button>
                                                  <ul class="dropdown-menu">
                                                      <li><a href="#upCat" class="ambil" data-toggle="modal" data-id="<?php echo $ca->categoryId;?>">Update</a></li>
                                                      <li><a href="<?php echo base_url(); ?>admin/delete/<?php echo $ca->categoryId;?>">Delete</a></li>
                                                  </ul>
                                              </td>
                                            </tr>
                                           <?php $no++;}}?>
                                                </tbody>
                                             </table><div class="halaman">Pages : <?php echo $page;?></div>
                                            ...
                                            <tr>
                                              ...
                                              <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="<?php //echo base_url(); ?>admin/updatequeued/<?php //echo $prob->caseId;?>">Queue</a></li>
                                                    <li><a href="<?php //echo base_url(); ?>admin/deletecase/<?php //echo $prob->caseId;?>">Delete</a></li>
                                                </ul>
                                              </td>-->
                                            </tr>
                                           <?php }?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="grid simple ">
                            ...
                            <div class="grid-body no-border">
                                  <h3>On Progress  <span class="semi-bold">Case</span></h3>
                                    <table class="table no-more-tables">
                                        <thead>
                                            <tr>
                                                <th style="width:10%">Time Opened</th>
                                        ...
                                        <tbody>
                                         <?php
                                            ...
                                            <tr>
                                              ...
                                              <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="#myProcess" class="proses" data-toggle="modal" data-id="<?php //echo $pross->caseId;?>">Update</a></li>
                                                    <li><a href="<?php //echo base_url(); ?>admin/closecase/<?php //echo $pross->caseId;?>">Close</a></li>
                                                    <li><a href="<?php //echo base_url(); ?>admin/deletecaseproses/<?php //echo $pross->caseId;?>">Delete</a></li>
                                                </ul>
                                              </td>-->
                                            </tr>
                                           <?php }?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="grid simple ">
                            ...
                            <div class="grid-body no-border">
                                  <h3>Closed <span class="semi-bold">Case</span></h3>
                                    <table class="table no-more-tables">
                                        <thead>
                                            <tr>
    ...
    <div class="modal fade" id="myCatt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="<?php echo base_url();?>admin/addcategory" method="POST" name="addcategory" id="addcategory">
                  ...
                  <div class="modal fade" id="upCat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <form action="<?php echo base_url();?>admin/updatecategory" method="POST" name="updatecategory" id="updatecategory">
                          <div class="row form-row">
                            <div class="col-md-12">
    ...
    <div class="modal fade" id="myProcess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <form action="<?php echo base_url();?>admin/updateprocess" method="POST" name="addproses" id="addproses">
                          <div class="row form-row">
                            <div class="col-md-12">
                              <input type="text" class="form-control" name="analis" placeholder="Analyst Name">
                            </div>
                            <div class="col-md-12">
